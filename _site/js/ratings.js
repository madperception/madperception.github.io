...
var totalVotesInc = 0;
var averageScore = 0;var rating = $(".rating-histogram");
var totalVotes = 0;
var secondaryVotes = 0;
var totalVotesInc = 0;
var averageScore = 0;
...
$(".rating-bar-container").each(function() {
  ...
  $(this)
    .children(".bar-number")
    .html(Number($(this).attr("valuenow")).toLocaleString("ru"));
});
averageScore = (totalVotesInc / totalVotes)
  .toFixed(1)
  .toString()
  .replace(".", ",");
rating.attr({
...
$(".rating-bar-container").each(function() {
  if ($(this).attr("valuenow") == highest) {
    ...
    $(this)
      .children(".bar")
      .width($(this).attr("valuenow") * 200 / rating.attr("valuemax") + "%");
  }
});

$(".reviews-num").html(
  " " + Number(rating.attr("valuemax")).toLocaleString("ru")
);
